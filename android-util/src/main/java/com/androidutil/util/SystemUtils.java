...
public class SystemUtils {
    ...
    public static void imageCapture(Activity activity, String path, int requestCode) {
        imageCapture(activity,path,getFileProviderAuthority(activity),requestCode);
    }
    /**
     * 拍照
     *
     ...
     * @param requestCode
     */
    public static void imageCapture(Activity activity, String path, String authority,
                                    int requestCode) {
    ...
    public static void imageCapture(Fragment fragment, String path, int requestCode) {
        imageCapture(fragment,path,getFileProviderAuthority(fragment.getContext()),requestCode);
    }
     ...
     * @param requestCode
     */
    public static void imageCapture(Fragment fragment, String path, String authority,
                                    int requestCode) {
        Intent intent = new Intent(MediaStore.ACTION_IMAGE_CAPTURE);
        if (!TextUtils.isEmpty(path)) {
            Uri uri = null;
            if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.N){
                uri = FileProvider.getUriForFile(fragment.getContext(), authority, new File(path));
            }else{
                uri = Uri.fromFile(new File(path));
            }
            intent.putExtra(MediaStore.EXTRA_OUTPUT, uri);
    ...
    public static void installApk(Context context,File file){
        installApk(context,file,getFileProviderAuthority(context));
    }
